...
Project Workflow
Satellite HDF5 Data ↓ Data Extraction using Python (h5py) ↓ Dataset Creation (Latitude, Longitude, Rainfall, OLR) ↓ Data Cleaning and Sampling ↓ Rainfall Visualization (Geospatial Mapping) ↓ Machine Learning Model ↓ Model Evaluation (RMSE)

Repository Structure
insat_project │ ├── scripts │ ├── extract_olr.py │ ├── extract_rainfall.py │ ├── visualization.py ├── model.py ├── README.md └── .gitignore
...
python scripts/extract_olr.py python scripts/extract_rainfall.py
